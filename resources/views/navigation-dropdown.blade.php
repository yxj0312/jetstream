                ...
                <x-jet-dropdown>
                    ...
                    <x-slot name="content">
                        <div class="block px-4 py-2 text-xs text-gray-400">
                           <x-jet-nav-link href="{{ route('alpine.test1') }}" :active="request()->routeIs('alpine.test1')">
                                Test1: Memory Game
                            </x-jet-nav-link>
                        </div>
                        <div class="block px-4 py-2 text-xs text-gray-400">
                           <x-jet-nav-link href="{{ route('alpine.test2') }}" :active="request()->routeIs('alpine.test2')">
                                Test2: Data Binding
                            </x-jet-nav-link>
                        </div>
                        <div class="block px-4 py-2 text-xs text-gray-400">
                        ...
                        <div class="block px-4 py-2 text-xs text-gray-400">
                           <x-jet-nav-link href="{{ route('alpine.test4') }}" :active="request()->routeIs('alpine.test4')">
                        ...
                        <div class="block px-4 py-2 text-xs text-gray-400">
                           <x-jet-nav-link href="{{ route('alpine.test7') }}" :active="request()->routeIs('alpine.test7')">
                                Test7: Transitions 102
                            </x-jet-nav-link>
                        </div>
                        <div class="block px-4 py-2 text-xs text-gray-400">
                           <x-jet-nav-link href="{{ route('alpine.test8') }}" :active="request()->routeIs('alpine.test8')">
                                Test8: Handling Custom Events
                            </x-jet-nav-link>
                        </div>
                    </x-slot>
                </x-jet-dropdown>
